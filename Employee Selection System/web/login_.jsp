...
<div class="login-card"><img src="assets/img/Untitled.png" class="profile-img-card" style="margin-left:40px;" />
    ...
    <form class="form-signin"  method='post' action="j_security_check"><span class="reauth-email"> </span>

        <% request.getSession().setAttribute("referredFrom","login.jsp");%>
        <input type="email" maxlength="50"  required placeholder="Email" autofocus class="form-control" id="inputEmail" name= "j_username"/>
        <input type="password" required placeholder="PPPPassword" class="form-control" id="inputPassword" name="j_password"  minlength="6" maxlength="50" />
